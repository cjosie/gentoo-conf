...
static constexpr auto qt_meta_stringdata_ZN6Breeze15ExceptionDialogE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN6Breeze15ExceptionDialogE[] = {
...
Q_CONSTINIT const QMetaObject Breeze::ExceptionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6Breeze15ExceptionDialogE.offsetsAndSizes,
    qt_meta_data_ZN6Breeze15ExceptionDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6Breeze15ExceptionDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void Breeze::ExceptionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ExceptionDialog::*)(bool );
            if (_q_method_type _q_method = &ExceptionDialog::changed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Breeze::ExceptionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6Breeze15ExceptionDialogE.stringdata0))
