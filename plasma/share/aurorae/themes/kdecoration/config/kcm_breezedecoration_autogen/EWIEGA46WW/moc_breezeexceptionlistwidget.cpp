...
static constexpr auto qt_meta_stringdata_ZN6Breeze19ExceptionListWidgetE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN6Breeze19ExceptionListWidgetE[] = {
...
Q_CONSTINIT const QMetaObject Breeze::ExceptionListWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6Breeze19ExceptionListWidgetE.offsetsAndSizes,
    qt_meta_data_ZN6Breeze19ExceptionListWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6Breeze19ExceptionListWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void Breeze::ExceptionListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ExceptionListWidget::*)(bool );
            if (_q_method_type _q_method = &ExceptionListWidget::changed; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *Breeze::ExceptionListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6Breeze19ExceptionListWidgetE.stringdata0))
