...
namespace {
struct qt_meta_tag_ZN6Breeze12ConfigWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6Breeze12ConfigWidgetE = QtMocHelpers::stringData(
    "Breeze::ConfigWidget",
    "updateChanged",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6Breeze12ConfigWidgetE[] = {
...
Q_CONSTINIT const QMetaObject Breeze::ConfigWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6Breeze12ConfigWidgetE.offsetsAndSizes,
    qt_meta_data_ZN6Breeze12ConfigWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6Breeze12ConfigWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *Breeze::ConfigWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6Breeze12ConfigWidgetE.stringdata0))
