...
#define kcm_breezedecoration_EXPORTS 1
...
#define KPLUGINFACTORY_PLUGIN_CLASS_INTERNAL_NAME kcm_breezedecoration_factory
...
#define TRANSLATION_DOMAIN "breeze_kwin_deco"
